...
export function visage(selector: string, cfg: VisageConfig) {
  ...
  const faceStroke = alterHexColor(cfg.faceFill, 0.2);

  element.innerHTML = `
      <div class="visage ${cfg.rounded ? "rounded" : ""} ">
        <svg width="100%" height="100%" viewBox="0 0 200 200">
          ${background({ fill: cfg.backgroundFill })}
          ${neck({ fill: cfg.faceFill, stroke: faceStroke })}
          ${body({ fill: cfg.bodyFill, stroke: alterHexColor(cfg.bodyFill) })}
          ${ears({ fill: cfg.faceFill, stroke: faceStroke })}
          ${face({ fill: cfg.faceFill, stroke: faceStroke })}
          ${mouth({
            fill: alterHexColor(cfg.faceFill, 0.1),
            stroke: faceStroke,
          })}
          ${eyes({
            eyesFill: cfg.eyesFill,
            stroke: faceStroke,
          })}
          ${nose({ stroke: faceStroke })}
          ${eyeBrows({ fill: cfg.hairFill })}
          ${hair({
            fill: cfg.hairFill,
            stroke: alterHexColor(cfg.hairFill, -0.1),
          })}
        </svg>
      </div>
    `;
...
function neck({ fill, stroke }: { fill: string; stroke: string }) {
  return `
    <path
      style="display:inline;fill:${fill};fill-opacity:1;stroke:${stroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function body({ fill, stroke }: { fill: string; stroke: string }) {
  return `
    <path
       style="fill:${fill};fill-opacity:1;stroke:${stroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function ears({ fill, stroke }: { fill: string; stroke: string }) {
  return `
   <g
       id="g27"
...
function face({ fill, stroke }: { fill: string; stroke: string }) {
  return `
    <path
       style="display:inline;fill:${fill};fill-opacity:1;stroke:${stroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function mouth({ fill, stroke }: { fill: string; stroke: string }) {
  return `
    <g
       id="g33"
       inkscape:label="mouth">
      <path
         style="fill:${fill};fill-opacity:1;stroke:none;stroke-width:1.16979;stroke-linecap:round;stroke-opacity:1"
         ...
         sodipodi:nodetypes="cccccc" />
      <path
         style="display:inline;fill:none;fill-opacity:1;stroke:${stroke};stroke-width:1.16979;stroke-linecap:round;stroke-opacity:1"
...
function eyes({ eyesFill, stroke }: { eyesFill: string; stroke: string }) {
  return `
    <g
       id="g25"
      ...
      <path
         style="display:inline;fill:#ffffff;fill-opacity:1;stroke:${stroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
         ...
         inkscape:label="eye-left" />
      <circle
         style="display:inline;fill:${eyesFill};fill-opacity:1;stroke:none;stroke-width:1.19916;stroke-linecap:round;stroke-dasharray:none;stroke-opacity:1"
         id="path5-1"
         cx="-78.917717"
         cy="90.381569"
         transform="scale(-1,1)"
...
function nose({ stroke }: { stroke: string }) {
  return `
      <path
       id="path16"
       style="display:inline;fill:none;fill-opacity:1;stroke:${stroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function hair({ fill, stroke }: { fill: string; stroke: string }) {
  return `
      <path
       style="display:inline;fill:${fill};fill-opacity:1;stroke:${stroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function eyeBrows({ fill }: { fill: string }) {
  return `
      <path
       id="path20-3"
       style="display:inline;fill:${fill};fill-opacity:1;stroke:none;stroke-width:1;stroke-linecap:round;stroke-opacity:1"
