...
function neck({ faceFill, faceStroke }: SvgProps) {
  return `
    <path
      style="display:inline;fill:${faceFill};fill-opacity:1;stroke:${faceStroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function body({ bodyFill, bodyStroke }: SvgProps) {
  return `
    <path
       style="fill:${bodyFill};fill-opacity:1;stroke:${bodyStroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function ears({ faceFill, faceStroke }: SvgProps) {
  return `
   <g
       id="g27"
      ...
      <path
         style="fill:${faceFill};fill-opacity:1;stroke:${faceStroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function face({ faceFill, faceStroke }: SvgProps) {
  return `
    <path
       style="display:inline;fill:${faceFill};fill-opacity:1;stroke:${faceStroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function mouth({ mouthFill, faceStroke }: SvgProps) {
  return `
    <g
       id="g33"
       inkscape:label="mouth">
      <path
         style="fill:${mouthFill};fill-opacity:1;stroke:none;stroke-width:1.16979;stroke-linecap:round;stroke-opacity:1"
         ...
         sodipodi:nodetypes="cccccc" />
      <path
         style="display:inline;fill:none;fill-opacity:1;stroke:${faceStroke};stroke-width:1.16979;stroke-linecap:round;stroke-opacity:1"
...
function eyes({ eyesFill, faceStroke }: SvgProps) {
  return `
    <g
       id="g25"
      ...
      <path
         style="display:inline;fill:#ffffff;fill-opacity:1;stroke:${faceStroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function nose({ faceStroke }: SvgProps) {
  return `
      <path
       id="path16"
       style="display:inline;fill:none;fill-opacity:1;stroke:${faceStroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
...
function hair({ hairFill, hairStroke }: SvgProps) {
  return `
      <path
       style="display:inline;fill:${hairFill};fill-opacity:1;stroke:${hairStroke};stroke-width:1;stroke-linecap:round;stroke-opacity:1"
